$(document).ready(() => {
  $("#searchtrendingmovieweekly").on('click', (e) => {
    e.preventDefault();
    
    getTrendingmovieweekly();
  });
});


function getTrendingmovieweekly(){
  //make request to api using axios
  // Make a request for a user with a given ID
  axios.get("https://api.themoviedb.org/3/trending/movie/week?api_key=98325a9d3ed3ec225e41ccc4d360c817###")
